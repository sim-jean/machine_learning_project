...
tables_stlima <- read.dta13("./tables_stlima.dta")
...
table_7 <- mutate(table_7, straven_r1=(raven_r1-mean(raven_r1))/sd(raven_r1))
...
table_7 <- mutate(table_7, straven_r2=(raven_r2-mean(raven_r2))/sd(raven_r2))
table_7 <- mutate(table_7, stxo_r2=(xo_r2-mean(xo_r2))/sd(xo_r2))
